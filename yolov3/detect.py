...
def detect(im0):
    img = ds.letterbox(im0, 640)[0]
    img = img[:, :, ::-1].transpose(2, 0, 1)  # BGR to RGB, to 3x416x416
    img = numpy.ascontiguousarray(img)
    pred = getDetectResult(img)
    box = []
    cls_ids = []
    cls_conf = []
    print(pred)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--weights', nargs='+', type=str, default='yolov3.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='../coco128/images', help='source')  # file/folder, 0 for webcam
    ...
    # img = cv2.imread("I:\\track\\yolo\\coco128\\images\\0.jpg")
    # img = cv2.resize(img, (640, 480))
    # box, cls_ids, cls_conf = detect(img)
    # print(box)
    # print(cls_ids)
    # print(cls_conf)
